...
# ========================================
# COMPATIBILITY WITH PYBULLET VERSION
# ========================================

# For easy porting from PyBullet version, provide the same structure
LIST_ACTUATORS_GRIPPER_FINGERS_INDEX = GRIPPER_ACTUATORS_INDEX
LIST_ACTUATORS_GRIPPER_FINGERS_MIDDLE = GRIPPER_ACTUATORS_MIDDLE
LIST_ACTUATORS_GRIPPER_FINGERS_RING = GRIPPER_ACTUATORS_RING
LIST_ACTUATORS_GRIPPER_FINGERS_LITTLE = GRIPPER_ACTUATORS_LITTLE
LIST_ACTUATORS_GRIPPER_FINGERS_THUMB = GRIPPER_ACTUATORS_THUMB

# Main list for closing all fingers (equivalent to LIST_ID_GRIPPER_FINGERS_ACTUATORS)
LIST_ACTUATORS_GRIPPER_FINGERS_ALL = GRIPPER_ACTUATORS_ALL_FINGERS
